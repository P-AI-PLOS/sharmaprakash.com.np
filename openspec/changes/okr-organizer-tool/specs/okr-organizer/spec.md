...
Stage 01 (Vision & OKRs) of the Donut CRM pipeline: a browser-only tool at
`/tools/okr-organizer/` for capturing customer-centric OKRs in explicit
who / does-what / by-how-much form, quarter-scoped, persisted per the
