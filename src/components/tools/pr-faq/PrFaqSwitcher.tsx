/**
 * "My drafts" dropdown — switches between saved PR/FAQ documents.
 * Mirrors OstTreeSwitcher.tsx in structure.
 */
import { useEffect, useRef, useState } from "react";
import { ChevronDown, FileText, Plus, Trash2 } from "lucide-react";
import { titleFor, type PrFaqRecord } from "~/utils/prfaq-store";

export default function PrFaqSwitcher({
  records,
  activeId,
  onSelect,
  onCreate,
  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      >
        ...
        <span className="truncate">{active ? titleFor(active) : "My drafts"}</span>
      ...
      {open && (
        <div
          role="listbox"
          aria-label="Your PR/FAQ documents"
