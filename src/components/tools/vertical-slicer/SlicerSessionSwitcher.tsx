/**
 * "My slicing sessions" dropdown — switches the slicer between saved sessions.
 * Cloned from OstTreeSwitcher (records / activeId / onSelect / onCreate / onDelete).
 */
import { useEffect, useRef, useState } from "react";
import { ChevronDown, Plus, Scissors, Trash2 } from "lucide-react";
import { titleFor, type SliceSession } from "~/utils/slicer-store";

export default function SlicerSessionSwitcher({
  records,
  activeId,
  onSelect,
  onCreate,
  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      >
        ...
        <span className="truncate">{active ? titleFor(active) : "My sessions"}</span>
      ...
      {open && (
        <div
          role="listbox"
          aria-label="Your slicing sessions"
