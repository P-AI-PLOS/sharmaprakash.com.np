/**
 * "My maps" dropdown — switches between saved story maps.
 * Mirrors PrFaqSwitcher.tsx in structure.
 */
...
export default function StoryMapSwitcher({
  records,
  activeId,
  onSelect,
  onCreate,
  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      >
        <Map size={15} strokeWidth={2} className="shrink-0 text-accent-700" />
        <span className="truncate">{active ? titleFor(active) : "My maps"}</span>
        <ChevronDown
          size={14}
          strokeWidth={2}
