---
title: "Workshop · Capstone: Design the Triple for a Rule You Keep Repeating"
...
> **Workshop chapter 5 of 5.** [Setup](/workshop/setup/) → [Lab 1](/workshop/lab-hook/) → [Lab 2](/workshop/lab-subagent/) → [Lab 3](/workshop/lab-skill/) → **Capstone (you are here)**.

The starter repo was a toy. The barrel-import rule was a toy. The point of the labs wasn't the rule — it was the *shape* of the solution: hook below, subagent in the middle, skill on top.

This chapter is the homework. Pick one rule *you* have been leaving in PR comments and design its triple.
...
If a teammate would benefit from the workshop, the most useful share is the [course landing](/course/hooks-subagents-skills/) — the deck and labs are linked from there.
