...
<TreeBuilder
  ...
  source={{
    ...
    chapterSlug: "habit",
    chapterLabel: "Making discovery a habit",
    href: "/course/continuous-discovery/habit/",
  }}
/>
...
<Checklist
  ...
  client:visible
  items={[
    "A product outcome statement — behavior, baseline, business outcome it serves (module 1)",
    "Interview snapshots from story-based customer interviews (module 2)",
    "A recruiting pipeline: outreach templates, a source list, a standing weekly slot (module 3)",
    "An opportunity space in customer words, one target chosen, ≥3 solutions attached (module 4)",
    "An assumption map and at least one test run with pre-written success criteria (module 5)",
