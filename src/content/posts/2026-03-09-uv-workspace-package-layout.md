...
The [`clipdex`](https://github.com/poudelprakash/clipdex) repo — the build-along the next series tackles in earnest — settles on five packages:
...
Full source: <https://github.com/poudelprakash/clipdex> — tags `series2-post2` mark the state of the repo at this post.
