---
title: "Figma vs Adobe XD: What Losing a Category Costs"
date: "2025-05-15T10:00:00+05:45"
category: ["Product"]
...
The problem was that XD answered the question "how do we build a Sketch competitor?" — a *what-to-build* question — while Figma had quietly changed the answer to a different question entirely: *where does design work happen?* That's a [where-to-play choice](/product-management/the-strategy-cascade-frameworks-i-actually-reach-for/), and it sits upstream of everything XD was optimizing.
...
- [Figma's S-1 and investor filings](https://www.sec.gov/Archives/edgar/data/1579878/000162828025033742/figma-sx1.htm) (investor.figma.com / SEC EDGAR) — the primary source for the $821M LTM revenue, 46% quarterly growth, and 132% NDR figures; the NDR discussion is the category-compounding argument in tier-1 form.
- TechCrunch, "[Adobe has a big hole to fill after the $20B Figma deal falls through](https://techcrunch.com/2023/12/18/adobe-has-a-big-hole-to-fill-after-the-20b-figma-deal-falls-through/)" (December 18, 2023) — contemporaneous account of the termination, the $1 billion fee, and what the collapse left Adobe without.
- [Contrary Research's Cursor company report](https://research.contrary.com/company/cursor) — the fullest public account of the Cursor trajectory and the fork-the-editor bet, with the company-reported ARR milestones and their caveats.
- [Microsoft's FY2025 10-K](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0000789019&type=10-K&dateb=&owner=include&count=40) — source for the 20M+ Copilot user figure, and worth skimming for how an incumbent frames a category it currently defines.
