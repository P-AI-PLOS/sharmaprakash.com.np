...
A typical first-run on a multi-year-old codebase comes in around thousands / dozens / hundreds / dozens / hundreds / dozens — and a smaller codebase comes in an order of magnitude lower across the board, with the same shape. Yours will be different. The shape will be similar.
