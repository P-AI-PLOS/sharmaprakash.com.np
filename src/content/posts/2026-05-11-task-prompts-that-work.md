...
The first three are about the codebase. The fourth is different. A task prompt is a **runnable recipe** — a self-contained document that, when given to an agent along with a scope ("migrate the Books list page"), produces correct code on the first attempt.
...
- `src/pages/Orders/` — canonical reference for routing + Outlet pattern
- `src/pages/Reports/MonthlySummary/` — most up-to-date working example
...
- Can you point at a file that does it right? ("Match `pages/Reports/MonthlySummary/containers/MonthlySummaryFormPage/`.")
...
> "Migrate the Books list page following `docs/prompts/list-page-migration.md`."
