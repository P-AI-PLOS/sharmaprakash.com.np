---
title: "Principle-First: When to Put the Frameworks Down"
date: "2026-06-16T10:00:00+05:45"
category: ["Product"]
categories: ["product-management"]
directory: product-management
excerpt: "After six posts of frameworks, here's the uncomfortable conclusion: the best product people I've worked with use fewer frameworks every year, not more. The frameworks were never the point — they're scaffolding for principles, and the goal is to reach the point where the scaffolding comes down."
...
RICE is a compression of *make your reasoning legible enough to argue with*. [The Mom Test](/product-management/discovery-and-customer-understanding/) compresses *past behavior is evidence, stated intent is politeness*. [One-way/two-way doors](/product-management/risk-reduction-and-decision-making-the-vocabulary-i-use-under-pressure/) compresses *decision speed should scale with reversibility*. OKRs compress *hold people to outcomes, not activity*. [Rumelt's kernel](/product-management/strategy-formation-how-to-tell-a-real-strategy-from-a-wish/) compresses *you haven't chosen anything until you've said what you're not doing*. The pre-mortem compresses *make dissent cheap before the decision, because it's expensive after*.
...
(This argument turned out to have a sequel. [The agile series](/product-management/the-agile-manifesto-four-values-twelve-principles/) reruns it against process frameworks instead of product ones — the manifesto's values as principles, Scrum and Kanban as the scaffolding, and what's left when a team takes the scaffolding down.)
...
- Richard Rumelt, [*Good Strategy / Bad Strategy*](https://www.amazon.com/s?k=good+strategy+bad+strategy+rumelt) — worth rereading through this lens: the whole book is one principle (diagnose first) defended against every framework that tries to replace it.
- Shane Parrish, [*The Great Mental Models*](https://www.amazon.com/s?k=the+great+mental+models+parrish) — the general case for holding principles rather than procedures.
- Charlie Munger's "[The Psychology of Human Misjudgment](https://fs.blog/great-talks/psychology-human-misjudgment/)" — the original argument that a latticework of principles beats any checklist, from a domain nowhere near product.
