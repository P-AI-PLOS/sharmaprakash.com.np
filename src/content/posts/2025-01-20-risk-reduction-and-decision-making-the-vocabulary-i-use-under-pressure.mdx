...
import DecisionDoorClassifier from "~/components/tools/decision-door/DecisionDoorClassifier.tsx";
...
<DecisionDoorClassifier client:visible mode="curated" source={{ type: "post" }} />
