...
This is where [positioning](/product-management/positioning-the-choice-you-make-before-the-market-makes-it-for-you/) gets its long-run answer. One to two pages, written by the CEO with the exec team, approved by the board. Reviewed yearly — reviewed, not rewritten. The review question is narrow: "which of our market-structure beliefs did this year's evidence confirm or break?" If none broke, the plan stands. Rewriting the 5-year annually is a tell that it was never a bet, just a mood.
...
Function leads draft their pieces, the CEO edits it into one coherent document — *edits*, meaning cuts, because the draft always contains six big rocks and the plan may contain at most four — and the board approves it alongside the budget. Two to three pages: the year's themes (each traceable to a 3-year capability gap or a 5-year position claim), the headcount plan by team, and the big rocks with a sentence each on what "done" means. The roadmap is *not* the yearly plan — the roadmap is a downstream artifact [built](/product-management/building-a-roadmap-you-can-defend/) inside the yearly plan's constraints, and the metrics per layer are [their own discipline](/product-management/north-star-metrics-and-metric-trees/) I won't reopen here.
...
**The 5-year plan as investor theater.** Written for the data room, full of TAM slides, never consulted between fundraises. The tell: nobody below the exec team can state its central bet. The [investor-facing view](/product-management/presenting-the-roadmap-to-investors/) should be *derived from* the real plan, the way the external roadmap is derived from the internal one — the moment the fundraising artifact *is* the plan, you've optimized the document for people who don't have to execute it.
...
1. **Play the deck-matching game.** Pull your company's vision, long-range plan, annual plan, and current quarter. Cover the headers, shuffle ten slides, and have someone assign each slide to a horizon. Every slide that could belong to two horizons marks a layer that isn't doing its own job.
2. **Run the five smell tests** from this post against the corresponding document. Any document that fails, don't rewrite it yet — first write down, in one sentence, the question that horizon should be answering for *your* company. The rewrite is easy once the question is honest.
3. **Install the escalation rule** before the next quarterly review: falsification claims in writing, assumption named, evidence attached, amendments logged. It takes one paragraph in the planning doc and it's the difference between a stack and a shrine.
