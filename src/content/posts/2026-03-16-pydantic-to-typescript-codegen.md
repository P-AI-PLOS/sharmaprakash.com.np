...
*Full source: [github.com/poudelprakash/clipdex](https://github.com/poudelprakash/clipdex) — tags `series2-post3` mark the state of the repo at this point. If the repo isn't public yet when you're reading this, treat the code blocks as illustrative — they're the layout once the decisions in posts 1 and 2 land.*
